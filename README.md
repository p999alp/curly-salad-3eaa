...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/curly-salad-3eaa#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/curly-salad-3eaa
```

A live public deployment of this template is available at [https://curly-salad-3eaa.templates.workers.dev](https://curly-salad-3eaa.templates.workers.dev)
